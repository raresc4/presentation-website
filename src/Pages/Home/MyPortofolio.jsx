...
export default function MyPortofolio() {
    return (
        <section className="portofolio--section" id="MyPortofolio">
            <div className="portofolio--container-box">
                ...
                <div>
                    <a href="https://github.com/raresc4" >
                ...
                {data?.portofolio?.map((item, index) => (
                    <div key={index} className="portofolio--section--card">
                        ...
                        <div className="portofolio--section--card--content">
                            <div>
                                <h3 className="portofolio--section--title">{item.title}</h3>
                                <p className="text-md">{item.description}</p>
                            </div>
                            <a href={item.realLink}>
                            <p className="text-sm portofolio--link">
                            {item.link}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
