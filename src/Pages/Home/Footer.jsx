      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100009349017808"
            ...
            <li>
              <a
                href="https://www.instagram.com/raresc4"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/rare%C8%99-alexandru-catan%C4%83-652022285/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
